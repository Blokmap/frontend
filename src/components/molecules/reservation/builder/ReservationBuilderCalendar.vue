...
import ReservationRequestTimeslot from '@/components/molecules/reservation/timeslots/ReservationRequestTimeslot.vue';
import ReservationTimeslot from '@/components/molecules/reservation/timeslots/ReservationTimeslot.vue';
