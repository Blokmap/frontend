...
const inWeekOf = computed<Date>({
    get: () => filters.value.inWeekOf || new Date(),
    set: (value: Date) => {
        filters.value.inWeekOf = value;
    },
});
...
const {
    ...
    data: reservations,
} = useReadProfileReservations(profileId, filters);
    ...
    <DashboardContent>
        <div class="grid grid-cols-4 items-start gap-4">
            ...
            <div class="space-y-4 md:col-span-3">
                ...
                <CalendarControls v-model:date="inWeekOf" />
