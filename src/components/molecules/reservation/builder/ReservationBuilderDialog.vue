...
import ReservationBuilderCalendar from '@/components/molecules/reservation/builder/ReservationBuilderCalendar.vue';
import ReservationBuilderLegend from '@/components/molecules/reservation/builder/ReservationBuilderLegend.vue';
import ReservationBuilderPopover from '@/components/molecules/reservation/builder/ReservationBuilderPopover.vue';
import ReservationBuilderSubmitDialog from '@/components/molecules/reservation/builder/ReservationBuilderSubmitDialog.vue';
...
const { data: reservations, refetch: refetchReservations } = useReadProfileReservations(
    profileId,
    reservationFilters,
);
...
const isLoading = computed<boolean>(() => {
    return props.openingsLoading || false;
});
