...
import AuthoritySelect from '@/components/features/authority/AuthoritySelect.vue';
import InstitutionSelect from '@/components/features/institution/InstitutionSelect.vue';
