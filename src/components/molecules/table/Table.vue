...
import TableLoadingState from '@/components/molecules/table/TableLoadingState.vue';
...
<template>
    <!-- Loading State & Content with transition -->
    <TableLoadingState
        v-if="loading"
        key="loading"
...
.card {
    ...
    .card__group {
        ...
        .card__group-header {
            @apply -mb-1 cursor-pointer rounded-lg bg-white p-3 shadow-sm;
        }
    }
