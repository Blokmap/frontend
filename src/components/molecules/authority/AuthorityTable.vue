...
import AuthorityTableCell from '@/components/molecules/authority/table/AuthorityTableCell.vue';
import InstitutionTableCell from '@/components/molecules/institution/table/InstitutionTableCell.vue';
