...
import ReservationStateBadge from '@/components/molecules/reservation/state/ReservationStateBadge.vue';
...
<template>
    <Table
        ...
        <template #row="{ data }">
            <TableCell column="Locatie" v-if="showLocation">
                <RouterLink
                    v-if="data.location"
            ...
            <TableCell column="Aanmaakdatum" v-if="showCreatedDate">
                {{
