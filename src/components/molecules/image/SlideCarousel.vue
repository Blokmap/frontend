...
<template>
    <div class="carousel" :class="{ 'carousel--disabled': disabled }">
...
.carousel__button {
    ...
    @apply rounded-full bg-white/90 text-sm text-gray-800 shadow-md transition-all hover:scale-110 hover:bg-white;
}
